...
test('Date comparison test',()=>{
  ...
  expect(isSameDay(new Date('2020-11-28T01:07:53.095Z'),new Date('2020-11-28T01:07:53.095Z'))).toBe(true) // 同じDate
  expect(isSameDay(new Date('2020-11-28T01:07:53.095Z'),new Date('2020-11-28T03:07:53.095Z'))).toBe(true) // 時間が異なる

  expect(isSameDay(new Date('2020-11-28T01:07:53.095'),new Date('2020-11-28T01:21:00.005'))).toBe(true)
  expect(isSameDay(new Date('2020-11-28T01:00:00.000'),new Date('2020-11-28T23:59:59.999'))).toBe(true)

  expect(isSameDay(new Date('2020-11-28T01:07:53.095'),new Date('2020-11-22T01:21:00.000'))).toBe(false)
  expect(isSameDay(new Date('2020-11-28T00:00:00.000'),new Date('2020-11-27T23:59:59.999'))).toBe(false)
})
...
test('Single Expression',()=>{
  ...
  expect(isDateMatchesToSingleExpression('日',new Date('2020/03/01'))).toBe(true)
  expect(isDateMatchesToSingleExpression('月',new Date('2020/06/01'))).toBe(true)
  expect(isDateMatchesToSingleExpression('火',new Date('2020/12/01'))).toBe(true)
  expect(isDateMatchesToSingleExpression('水',new Date('2020/07/01'))).toBe(true)
  expect(isDateMatchesToSingleExpression('木',new Date('2020/10/01'))).toBe(true)
  expect(isDateMatchesToSingleExpression('金',new Date('2020/05/01'))).toBe(true)
  expect(isDateMatchesToSingleExpression('土',new Date('2020/08/01'))).toBe(true)

  
  expect(isDateMatchesToSingleExpression('土',new Date('2020/03/01'))).toBe(false)
  expect(isDateMatchesToSingleExpression('金',new Date('2020/06/01'))).toBe(false)
  expect(isDateMatchesToSingleExpression('木',new Date('2020/12/01'))).toBe(false)
  expect(isDateMatchesToSingleExpression('日',new Date('2020/07/01'))).toBe(false)
  expect(isDateMatchesToSingleExpression('火',new Date('2020/10/01'))).toBe(false)
  expect(isDateMatchesToSingleExpression('月',new Date('2020/05/01'))).toBe(false)
  expect(isDateMatchesToSingleExpression('水',new Date('2020/08/01'))).toBe(false)

  expect(isDateMatchesToSingleExpression('日1',new Date('2020/03/01'))).toBe(true)
  expect(isDateMatchesToSingleExpression('月1',new Date('2020/06/01'))).toBe(true)
  expect(isDateMatchesToSingleExpression('火1',new Date('2020/12/01'))).toBe(true)
  expect(isDateMatchesToSingleExpression('水1',new Date('2020/07/01'))).toBe(true)
  expect(isDateMatchesToSingleExpression('木1',new Date('2020/10/01'))).toBe(true)
  expect(isDateMatchesToSingleExpression('金1',new Date('2020/05/01'))).toBe(true)
  expect(isDateMatchesToSingleExpression('土1',new Date('2020/08/01'))).toBe(true)

  expect(isDateMatchesToSingleExpression('20200301',new Date('2020/03/01'))).toBe(true)
  expect(isDateMatchesToSingleExpression('20200607',new Date('2020/06/07'))).toBe(true)
  expect(isDateMatchesToSingleExpression('20201206',new Date('2020/12/06'))).toBe(true)
  expect(isDateMatchesToSingleExpression('20200705',new Date('2020/07/05'))).toBe(true)
  expect(isDateMatchesToSingleExpression('20201004',new Date('2020/10/04'))).toBe(true)
  expect(isDateMatchesToSingleExpression('20200503',new Date('2020/05/03'))).toBe(true)
  expect(isDateMatchesToSingleExpression('20200802',new Date('2020/08/02'))).toBe(true)


  expect(isDateMatchesToSingleExpression('20200802',new Date('2020/03/01'))).toBe(false)
  expect(isDateMatchesToSingleExpression('20200503',new Date('2020/06/07'))).toBe(false)
  expect(isDateMatchesToSingleExpression('20201004',new Date('2020/12/06'))).toBe(false)
  expect(isDateMatchesToSingleExpression('20200301',new Date('2020/07/05'))).toBe(false)
  expect(isDateMatchesToSingleExpression('20201206',new Date('2020/10/04'))).toBe(false)
  expect(isDateMatchesToSingleExpression('20200607',new Date('2020/05/03'))).toBe(false)
  expect(isDateMatchesToSingleExpression('20200705',new Date('2020/08/02'))).toBe(false)

  expect(isDateMatchesToSingleExpression('火5',new Date('2020/01/01'))).toBe(false)

  expect(()=>isDateMatchesToSingleExpression('hogehoge',new Date('2020/08/02'))).toThrow(Error("Invalid area_days Expression"))
  expect(()=>isDateMatchesToSingleExpression('2020070a',new Date('2020/08/02'))).toThrow(Error("Invalid area_days Expression"))
